"""
Cleanup script for challenge missions test
Removes the challenge_test@gomums.com user and all related data
"""
import os
import psycopg2
...
def cleanup_test_user():
    ...
    try:
        ...
        print(f"\n✅ Cleanup complete! You can now run test_multi_goal_challenges.py")
